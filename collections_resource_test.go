...
func TestCollectionResourceMarshallJSON(t *testing.T) {
	testdata := testutil.ReadFileBytes(t, filepath.Join("./testdata", "collections.json"))
	...
	for i, test := range tests {
		...
		t.Run(fmt.Sprintf("%d", i), func(t *testing.T) {
			var resource interstellar.CollectionResource
			...
			var resource2 interstellar.CollectionResource
